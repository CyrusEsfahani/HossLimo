    ...
    const dummyServices = [
        {
            ...
            description: 'Travel in style to and from the airport with our luxury airport transfer service.',
        ...
        },
        {
            ...
            description: 'Reach your destination safely and comfortably with our point-to-point service.',
        ...
        },
        {
            ...
            description: 'Make your family vacation unforgettable with our luxury transportation.',
            imageUrl: '/assets/images/family.png',
        },
    ];
    return (<div className="w-full">
      {/* Hero Section */}
      <div className="relative bg-cover bg-center bg-no-repeat w-full h-[400px] md:h-[600px] lg:h-[700px]" style={{ backgroundImage: "url('/assets/images/LA.png')" }}>
      ...
      <div className="bg-gray-50 py-12 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 md:order-none">
            <img src="/assets/images/Comfort.png" alt="Professional Driver" className="w-full h-auto rounded-lg shadow-lg"/>
          </div>
          ...
          <div>
            ...
            <react_router_dom_1.Link to="/booking" className="inline-block bg-black text-white font-semibold py-3 px-6 rounded-lg shadow hover:shadow-lg transition-transform transform hover:-translate-y-1">
              Book Now
      ...
      <div className="bg-white py-12">
        <div className="container-custom pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {dummyServices.map((service) => (<div key={service.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src={service.imageUrl} alt={service.title} className="w-full h-48 object-cover"/>
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2">{service.title}</h3>
                  <p className="text-gray-600 mb-4">{service.description}</p>
                  <react_router_dom_1.Link to="/booking" className="text-black font-medium hover:underline flex items-center">
                    Book Now
